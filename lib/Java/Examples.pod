...
Java::Include::Examples - Example of how to use Java::Import to call into Java classes
...
their system and a posible third party or lagcy system.  Unfortunatly, for the most part the ability to make 
...
Let's begin by decriping the Java interfaces that we'll be working with.  We first have the Remote Interface 
